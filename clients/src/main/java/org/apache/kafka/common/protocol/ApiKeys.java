...
public enum ApiKeys {
    ...
    CONTROLLED_SHUTDOWN_SKIP_SAFETY_CHECK(1000, "ControlledShutdownSkipSafetyCheck", ControlledShutdownSkipSafetyCheckRequestData.SCHEMAS, ControlledShutdownSkipSafetyCheckResponseData.SCHEMAS);
